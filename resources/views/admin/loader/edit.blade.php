            ...
            <div class="card card-body mt-4">
                ...
                <form method="POST" action="{{ route('Loader.update', $Loader->id) }}">
                    ...
                    <div class="col-12">
                        ...
                        <input type="text" name="nama_loader" class="form-control" id="projectName"
                            value="{{ $Loader->nama_loader }}" required>
                    </div>
                    <div class="row mt-4">
                        <div class="col-6">
                            <label class="form-label">ORU</label>
                            <input type="text" name="oru" class="form-control" id="projectName"
                                value="{{ $Loader->nama_loader }}" required>
                        </div>
                        <div class="col-6">
                            <label class="form-label">AECM</label>
                            <input type="text" name="aecm" class="form-control" id="projectName"
                                value="{{ $Loader->nama_loader }}" required>
                        </div>
                    </div>
                    ...
                    <div class="row mt-4">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="rear_ladar" class="form-control" id="projectName"
                                value="{{ $Loader->nama_loader }}" required>
                        </div>

                        <div class="col-6">
                            <label class="form-label">FRONT LADAR</label>
                            <input type="text" name="front_ladar" class="form-control" id="projectName"
                                value="{{ $Loader->nama_loader }}" required>
                        </div>
                    </div>
                    <div class="row mt-4">
                        <div class="col-6">
                            ...
                            <select class="form-control" name="isShow" id="exampleFormControlSelect1">
                                <option value="1" @if ($Loader->isShow == '1') selected @endif>Aktif</option>
                                <option value="0" @if ($Loader->isShow == '0') selected @endif>Tidak Aktif</option>
                            </select>
                        </div>
                    </div>
